.PHONY: install lint fmt typecheck test bench report pdf clean
...
bench:
	uv run specdec bench --out-dir runs/latest --n-tokens 256

report:
	uv run specdec report --out-dir runs/latest
